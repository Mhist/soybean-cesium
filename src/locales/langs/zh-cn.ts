const local: App.I18n.Schema = {
  ...
  route: {
    ...
    about: "关于",
    cesium: "Cesium 示例",
    cesium_intro: "认识 Cesium 框架",
    "cesium_first-app": "打造第一个 Cesium 应用",
    cesium_setup: "Cesium 基础设置",
    cesium_viewer: "详讲 Viewer 查看器",
    cesium_skybox: "Cesium 天空盒",
    cesium_map: "自定义地图与地图叠加",
    cesium_terrain: "添加地形与自定义地形",
    cesium_coordinates: "坐标系与坐标系数值转换",
    "cesium_camera-position": "相机的方向和位置",
    "cesium_camera-animation": "相机动画与动态交互",
    "cesium_3d-objects": "添加物体与3D建筑物",
    "cesium_labels-billboards": "标签与广告牌",
    ...
    "cesium_primitive-entities": "Primitive多个实体与颜色修改",
    "cesium_entity-interaction": "与entity和primitive物体交互",
    "cesium_entity-material": "entity材质使用materialProperty",
    "cesium_polyline-material": "entity折线材质设置",
    "cesium_appearance-material": "Appearance外观与材质",
    "cesium_primitive-material": "primitive材质类型与设置",
    "cesium_fabric-shader": "fabric自定义着色器设置材质",
    "cesium_shader-builtins": "cesium着色器自带函数与变量",
    "cesium_appearance-shader": "Appearance编写着色器修改外观",
    ...
    cesium_3dtiles: "3DTiles与性能监控",
    "cesium_3dtiles-style": "根据不同条件设置3D_tiles样式",
    "cesium_3dtiles-advanced": "3Dtiles高级样式设置与条件渲染",
    function: "系统功能",
    alova: "alova示例",
