...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "cesium_3dtiles-advanced": () => import("@/views/cesium/3dtiles-advanced/index.vue"),
  "cesium_3dtiles-style": () => import("@/views/cesium/3dtiles-style/index.vue"),
  cesium_3dtiles: () => import("@/views/cesium/3dtiles/index.vue"),
  "cesium_appearance-material": () => import("@/views/cesium/appearance-material/index.vue"),
  "cesium_appearance-shader": () => import("@/views/cesium/appearance-shader/index.vue"),
  "cesium_camera-animation": () => import("@/views/cesium/camera-animation/index.vue"),
  "cesium_camera-position": () => import("@/views/cesium/camera-position/index.vue"),
  cesium_coordinates: () => import("@/views/cesium/coordinates/index.vue"),
  "cesium_custom-material": () => import("@/views/cesium/custom-material/index.vue"),
  "cesium_czml-dynamic": () => import("@/views/cesium/czml-dynamic/index.vue"),
  cesium_czml: () => import("@/views/cesium/czml/index.vue"),
  "cesium_entity-interaction": () => import("@/views/cesium/entity-interaction/index.vue"),
  "cesium_entity-material": () => import("@/views/cesium/entity-material/index.vue"),
  "cesium_fabric-shader": () => import("@/views/cesium/fabric-shader/index.vue"),
  "cesium_first-app": () => import("@/views/cesium/first-app/index.vue"),
  "cesium_flight-tracking": () => import("@/views/cesium/flight-tracking/index.vue"),
  "cesium_geojson-style": () => import("@/views/cesium/geojson-style/index.vue"),
  cesium_geojson: () => import("@/views/cesium/geojson/index.vue"),
  "cesium_geometric-shapes": () => import("@/views/cesium/geometric-shapes/index.vue"),
  cesium_intro: () => import("@/views/cesium/intro/index.vue"),
  cesium_kml: () => import("@/views/cesium/kml/index.vue"),
  "cesium_labels-billboards": () => import("@/views/cesium/labels-billboards/index.vue"),
  cesium_map: () => import("@/views/cesium/map/index.vue"),
  "cesium_polygons-volumes": () => import("@/views/cesium/polygons-volumes/index.vue"),
  "cesium_polyline-material": () => import("@/views/cesium/polyline-material/index.vue"),
  "cesium_primitive-entities": () => import("@/views/cesium/primitive-entities/index.vue"),
  "cesium_primitive-imagery": () => import("@/views/cesium/primitive-imagery/index.vue"),
  "cesium_primitive-material": () => import("@/views/cesium/primitive-material/index.vue"),
  cesium_setup: () => import("@/views/cesium/setup/index.vue"),
  "cesium_shader-builtins": () => import("@/views/cesium/shader-builtins/index.vue"),
